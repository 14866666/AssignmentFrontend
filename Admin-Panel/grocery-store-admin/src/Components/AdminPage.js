  ...
  return (
    <div className="admin-page">
      ...
      >
        ...
        <button className="green-button" onClick={closeAddModal}>
          Cancel
        </button>
      </Modal>
      ...
      {editingProduct && (
        ...
        >
          ...
          <input
            ...
            onChange={(e) => setImage(e.target.value)}
          />
          <button className="green-button" onClick={handleEdit}>
            Save
          </button>
          <button className="green-button" onClick={closeEditModal}>
            Cancel
          </button>
        </Modal>
      )}
